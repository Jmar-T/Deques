...
public class LinkedDeque<T> {
    ...
    public T getFirst() {
        if (size == 0) {
            throw new NoSuchElementException("Can't retrieve the first element of an empty Deque");
        }
        return head.getData();
    }
    ...
    public T getLast() {
        if (size == 0) {
            throw new NoSuchElementException("Can't retrieve the last element of an empty Deque");
        }
        return tail.getData();
    }
